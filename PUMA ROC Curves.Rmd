...
plot1 <- create_roc_plot(hair2_results$roc, "A. Self-Report Adherence Prediction of Hair Results
     (Neg + Low vs High)", "purple", "Hair (Neg + Low vs High), AUC")

# 2. Combined model (adherence score + urine 
plot2 <-  create_roc_plot(combined_results$roc, "B. Combined Self-Report Adherence and 
     Urine Result Prediction of Hair Results", "blue", "Hair (Neg + Low vs High), AUC")

# 2. Urine outcome
plot3 <- create_roc_plot(urine_results$roc, "C. Self-Report Adherence Prediction of Urine Results", "red", "Urine (Neg vs Pos), AUC")

# 3. Hair Outcome
plot4 <- create_roc_plot(hair_results$roc, "D. Self-Report Adherence Prediction of Hair Results 
     (Neg vs Pos)", "green", "Hair (Neg vs Pos), AUC")
